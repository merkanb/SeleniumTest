...
public class PositiveLoginTest extends TestBase {
    ...
    public void loginWithStudent() {
        driver.get(ConfigurationReader.get("url"));
        BrowserUtils1Me.waitForVisibility(loginPage.understandBtn,15);
        loginPage.understandBtn.click();
...
//        loginPage.loginBtn.click();
        BrowserUtils1Me.clickWithJS(loginPage.loginBtn);
    ...
    public void loginWithMethod() {
        driver.get(ConfigurationReader.get("url"));
//        loginPage.login(ConfigurationReader.get("usernameStudent"), ConfigurationReader.get("passwordStudent"));
        // login() created in Login class
