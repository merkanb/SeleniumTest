...
// get title of the new window
                ...
                BrowserUtils1Me.switchToWindow("New Window");
        ...
        public void list() {
                ...
                System.out.println("BrowserUtils.getElementsText(menuList) = " + BrowserUtils1Me.getElementsText(menuList));
        }
