...
public class VerifyConfirmationMessage {
    ...
    public static void main(String[] args) throws InterruptedException {
        /*
        --open the chrome browser        --navigate the "http://eurotech.study/login"        --enter email address "eurotech@gmail.com"
        --enter password "Test12345!"        --Click login button        --verify that confirmation message is "Welcome Teacher"
         */
